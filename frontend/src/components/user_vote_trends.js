      ...
      <table className="table table-hover">
        ...
        <tr>
          <td>
            ...
            <div>Total {finalNumber(runningTotal(props.data, all))} votes</div>
          </td>
          <td>
            ...
            <div>Total {finalNumber(runningTotal(props.data, month))} votes this month</div>
          </td>
          <td>
            ...
            <div>Total {finalNumber(runningTotal(props.data, week))} votes this week</div>
          </td>
          <td>
            <Sparklines height={100} width={120} data={runningTotal(props.data, day)}>
              <SparklinesBars style={{ fill: "red" }} />
              <SparklinesReferenceLine type="avg" />
            </Sparklines>
            <div>Total {finalNumber(runningTotal(props.data, day))} votes today</div>
          </td>
        </tr>
        </tbody>
      </table>
